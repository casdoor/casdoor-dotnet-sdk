...
public interface ICasdoorAccountClient
{
    ...
    public Task<CasdoorResponse?> SyncLdapUsersAsync(string owner, string ldapId, IEnumerable<CasdoorLdapUser> users, CancellationToken cancellationToken = default);
